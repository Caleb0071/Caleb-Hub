if game.PlaceId == 2753915549 or game.PlaceId == 4442272183 or game.PlaceId == 7449423635 then
  ...
  wait(10)
      ...
      do
          local ui = game.CoreGui:FindFirstChild("calebGUI")
          if ui then
              ui:Destroy()
          end
      end
      ...
      function library:AddWindow(text,keybind)
          ...
          local CalebHub = Instance.new("TextLabel")
          CalebHub.Name = "CalebHub"
          CalebHub.Parent = Page
          CalebHub.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
          CalebHub.BackgroundTransparency = 1.000
          CalebHub.Position = UDim2.new(0.113333493, 0, 0, 0)
          CalebHub.Size = UDim2.new(0, 110, 0, 20)
          CalebHub.Font = Enum.Font.GothamSemibold
          CalebHub.Text = text
          CalebHub.TextColor3 = Color3.fromRGB(225, 0, 0)
          CalebHub.TextSize = 11.000
          CalebHub.TextXAlignment = Enum.TextXAlignment.Left
  ...
  elseif placeId == 7449423635 then
      ...
      local sxhub = library:AddWindow("caleb | Bloxfruit!",Enum.KeyCode.RightControl)
  ...
  set:AddLabel("Setting")
      ...
      set:AddButton("Copy link caleb Discord ",function()
  ...
  wait(10)
      ...
      --
      local RenUi = library:AddWindow("caleb | King Legacy",Enum.KeyCode.RightControl)
      --
