print("FUTURO DISCORD")
toclipboard("FUTURO DISCORD")
if game:GetService("ReplicatedStorage").Effect.Container:FindFirstChild("Morte") then
	game:GetService("ReplicatedStorage").Effect.Container.Death:Destroy()
end
if game:GetService("ReplicatedStorage").Effect.Container:FindFirstChild("Renascer") then
...
_G.Settings = {
	...
	Main = {
		...
		["Flash Auto Farm Level"] = false,

		--[Mob Aura]

		["Distância Mob Aura"] = 1000, -- {Max : 5000} 
		["Mob Aura"] = false,

		--[SEA 1]
		["Auto Novo Mundo"] = false,
		["Auto Saber"] = false,
		["Auto Pole"] = false,

		["Auto Comprar Habilidade"] = false,

		--[SEA 2]
		["Auto SEA 3"] = false,
		["Auto Factory"] = false,
		["Auto Factory Hop"] = false,
		["Auto Missão Bartilo"] = false,
		...
		["Auto Comprar Legendary Sword"] = false,
		["Auto Comprar Enchanment Haki"] = false,

		--[SEA 3]
		["Auto Holy Torch"] = false,
		["Auto Buddy Swords"] = false,
		["Auto Farm Chefe Hallow"] = false,
		["Auto Rainbow Haki"] = false,
		["Auto Elite Hunter"] = false,
		["Auto Musketeer Hat"] = false,
		["Auto Buddy Sword"] = false,
		["Auto Farm Osso"] = false,
	...
	Boss = {
		["Auto Todos os Chefes"] = false,
		["Auto Selecionar Chefe"] = false,
		["Selecionar Chefe"] = {},
	...
	Mastery = {
		...
		["Auto Farm Maestria de Fruta"] = false,
		["Auto Farm Maestria de Arma"] = false,
		["Mob Health (%)"] = 15,
	},
	Configs = {
		["Double Quest"] = false,
		...
		["Ataque Rapido"] = true,
		["Velocidade do Ataque Rapido"] = {"Rapido"}, --{Normal,Rapido,Devagar}
		...
		--[Configuração de Mob]
		["Mostrar Hitbox"] = false,
		["Trazer Mob"] = true,
		["Desabilitar Damage"] = false,

	},
	Stat = {
		--[Auto Status]
		["Habilitar Auto Status"] = false,
		["Auto Status Kaitun"] = false,

		["Selecionar Status"] = {"Melee"}, --{Max Stats,Melee,Defense,Sword,Devil Fruit,Gun}
		["Selecionar Pontos"] = 3, --{Recomendado , Max : 9}

		--[Auto Resgatar Codigo]

		["Habilitar Auto Resgatar Codigo"] = false,
		["Selecionar Level Resgatar Codigo"] = 1, --{Max : 2400}
	},
	...
	Teleport = {
		["Teleportar para Sea Beast"] = false,
	},

	Fruits = {
		["Auto Comprar Frutas Randomicas"] = false,
		["Auto Loja de Frutas"] = false,

		["Selecionar Fruta"] = {}, -- {"Bomb-Bomb","Spike-Spike","Chop-Chop","Spring-Spring","Kilo-Kilo","Spin-Spin","Kilo-Kilo","Spin-Spin","Bird: Falcon","Smoke-Smoke","Flame-Flame","Ice-Ice","Sand-Sand","Dark-Dark","Revive-Revive","Diamond-Diamond","Light-Light","Love-Love","Rubber-Rubber","Barrier-Barrier","Magma-Magma","Door-Door","Quake-Quake","Human-Human: Buddha","String-String","Bird-Bird: Phoenix","Rumble-Rumble","Paw-Paw","Gravity-Gravity","Dough-Dough","Shadow-Shadow","Venom-Venom","Control-Control","Soul-Soul","Dragon-Dragon"}
		["Auto Comprar Fruta Sniper"] = false,
	},
	...
	Raids = {
		...
		["Kill Aura"] = false,
		["Auto Awaken"] = false,
		["Auto Proximo Ponto"] = false,

		["Selecionar Raid"] = {}, -- {"Flame","Ice","Quake","Light","Dark","String","Rumble","Magma","Human: Buddha","Sand","Bird: Phoenix","Dough"},
	},
...
if v:IsA("Part") then
	...
	EnemySpawnsX2.Parent = workspace.EnemySpawnsend
...
function LoadSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfolder("Caleb Hub Premium Scripts") then
			makefolder("Caleb Hub Premium Scripts")
		end
		if not isfolder("Caleb Hub Premium Scripts/Blox Fruits/") then
			makefolder("Caleb Hub Premium Scripts/Blox Fruits/")
		end
		if not isfile("Caleb Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			writefile("Caleb Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(_G.Settings))
		else
			local Decode = game:GetService("HttpService"):JSONDecode(readfile("Caleb Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json"))
			for i,v in pairs(Decode) do
				_G.Settings[i] = v
			end
		end
	else
		return warn("Status : Executor Indetectado")
	end
end
...
function SaveSettings()
	if readfile and writefile and isfile and isfolder then
		if not isfile("Caleb Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json") then
			...
			writefile("Caleb Hub Premium Scripts/Blox Fruits/" .. game.Players.LocalPlayer.Name .. ".json", game:GetService("HttpService"):JSONEncode(Array))
		end
	else
		return warn("Status : Executor Indetectado")
	end
