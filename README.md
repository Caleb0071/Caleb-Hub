...
getgenv()['Check_Setting'] = function(Name)
    if not _G.Dis and not isfolder('Caleb Hub BF Premium') then
        makefolder('Caleb Hub BF Premium')
    end
    if not _G.Dis and not isfile('Caleb Hub BF Premium/'..Name..'.json') then
        writefile('Caleb Hub BF Premium/'..Name..'.json',JsonEncode(_G.Setting_table))
    end
end
getgenv()['Get_Setting'] = function(Name)
    if not _G.Dis and isfolder('Caleb Hub BF Premium') and isfile('Caleb Hub BF Premium/'..Name..'.json') then
        _G.Setting_table = JsonDecode(readfile('Caleb Hub BF Premium/'..Name..'.json'))
...
local win = library:Window("Caleb",[[Hub]],[[Version : Premium ]],"9606070311",Enum.KeyCode.RightControl)
